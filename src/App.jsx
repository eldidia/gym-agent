...
// ─── AI (proxied through Apps Script — fixes CORS) ───────────
function buildSystemPrompt(username, history, equipment) {
  ...
  const equipSection = equipment.length
...
כללי עבודה:
• שאל שאלה קצרה (1–2): איזה יום תוכנית (A/B/C), אנרגיה (1–5).
• תוכנית 3 ימים: A=רגליים+ליבה, B=דחיפה עליונה, C=משיכה+ליבה.
• **ציין מספר מכשיר** בכל המלצת תרגיל (למשל: "סקוואט — מכשיר 3").
• המלץ עומסים ספציפיים בהתבסס על ההיסטוריה. שיפור → +2.5–5 ק"ג.
• כשהמשתמש רושם תרגיל — אמת ועדכן המלצה.
